...
public class Formulario extends JFrame {
    ...
    public Formulario() {
        ...
        lblSexo.setBounds(21, 380, 95, 22);
        ...
        btnReportes = new JButton("Mostrar Reportes");
        ...
        btnBuscar.setBounds(460, 220, 184, 34);
    ...
    private void guardarDatos() {
        try {
            ...
            if (nombre.isEmpty() || cedula.isEmpty() || carrera == null || sexo == null) {
    ...
    private void buscarPorCedula() {
        ...
        if (cedula != null && !cedula.isEmpty()) {
            ...
            if (estudiante != null) {
                ...
                JOptionPane.showMessageDialog(this, "No se encontró ningún estudiante con esa cédula.", "Búsqueda", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    }

    private void mostrarInformacionEstudiante(Estudiantes estudiante) {
    ...
    private void mostrarReportes() {
        dispose();
        Reporte reportes = new Reporte(becas);
